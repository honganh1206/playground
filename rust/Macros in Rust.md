> Macros are a way of writing code that *writes other code*. Functions let you reuse _moves_. Macros let you reuse _blueprints_. See [[Macros in programming languages]].
